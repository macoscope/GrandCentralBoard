Pod::Spec.new do |s|
  ...
  s.source_files = 'GrandCentralBoard/GrandCentralBoard/Core/*.swift'

  s.dependency 'Alamofire', '~> 3.0'
  s.dependency 'Decodable', '~> 0.4'

  spec.subspec 'Watch' do |watch|
    watch.source_files = 'GrandCentralBoard/GrandCentralBoard/Widgets/Watch/*.swift'
  end
