...
struct AreaBarChartViewModel {
    ...
    static func emptyViewModel(header header: String? = nil, subheader: String? = nil, historicalCharts: [AreaBarChartComponentViewModel] = []) -> AreaBarChartViewModel {
        let items = [
        ...
        let mainChart = AreaBarChartComponentViewModel(barItems: items, horizontalAxisCountLabelText: "0", headerText: "HARVEST BURN REPORT", subheaderText: "Monday 28.03.2016")

        return AreaBarChartViewModel(mainChart: mainChart, componentCharts: historicalCharts, horizontalAxisStops: 20, horizontalAxisLabelText: "people billing:", centerText: "We didn't work yesterday")
    }
}
